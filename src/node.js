...
import cacheDatabase from "spreadable/src/cache/transports/database/index.js";
import databaseLoki from "./db/transports/loki/index.js";
import serverExpress from "./server/transports/express/index.js";
...
const Node = node();
const CacheDatabaseStoracle = cacheDatabase();
const DatabaseLokiStoracle = databaseLoki();
const ServerExpressStoracle = serverExpress();
  ...
  return class NodeStoracle extends (Parent || Node) {
    ...
    getFilePath(hash) {
      ...
      for (let i = 0, o = 0; i < this.__dirNestingSize; i++, o += this.__dirNameLength) {
        subs.push(hash.slice(o, o + this.__dirNameLength));
      }
